...
public class SqliteToRealmMigrator {
    ...
    private static final String TAG = SqliteToRealmMigrator.class.getName();

    private final SQLiteDatabase sqLiteDatabase;

    private final RealmConfiguration realmConfig;

    private MigrationStats migrationStats = new MigrationStats();

    private Company company;

    private Map<String, Configuration> currencyConfigs = new HashMap<>();

    private SqliteToRealmMigrator(SQLiteDatabase sqLiteDatabase, RealmConfiguration realmConfig) {
    ...
    public static class Builder {
        ...
        public Builder sqlitePath(String sqlitePath) {
            this.sqlitePath = sqlitePath;
            return this;
        }

        public Builder realmPath(String realmPath) {
            this.realmPath = realmPath;
            return this;
        }

        public Builder realmPassword(byte[] realmPassword) {
        ...
        public SqliteToRealmMigrator build() {
            String realmName = realmPath.substring(realmPath.lastIndexOf("/") + 1);
            String realmDirectory = realmPath.substring(0, realmPath.lastIndexOf("/"));
            ...
            SQLiteDatabase sqLiteDatabase = SQLiteDatabase.openDatabase(sqlitePath, null, SQLiteDatabase.OPEN_READONLY);
            SqliteToRealmMigrator migrator = new SqliteToRealmMigrator(sqLiteDatabase, realmConfig);
            migrator.migrationStats.setRealmFilePath(realmPath);
            return migrator;
        }
    }
    ...
    public void migrateItemData() throws MigrationException {
        Log.d(TAG, "Migrating Item data...");
        migrateProductGroupData();
        migrateProductData();
    }

    private void migrateProductData() throws MigrationException {
        ...
        try {
            ...
            productDataCursor = getSqliteDatabase().rawQuery(sql.toString(), null);
    ...
    private void migrateProductGroupData() throws MigrationException {
        ...
        try {
            ...
            realm = getRealm();
            productGroupCursor = getSqliteDatabase().rawQuery(sqlBuilder.toString(), null);
    ...
    public Company migrateCompanyData() throws MigrationException {
        ...
        try {
            ...
            companiesCursor = getSqliteDatabase().rawQuery(sqlBuilder.toString(), null);
                    ...
                    realm.executeTransaction(new Realm.Transaction() {
                        ...
                        public void execute(Realm realm) {
                            try {
                                ...
                                migrationStats.setCompanyName(company.getName());
    ...
    public void migrateConfigurationData() throws MigrationException {
        ...
        try {
            ...
            configurationCursor = getSqliteDatabase().rawQuery(sqlBuilder.toString(), null);
    ...
    public void migrateCurrencyData() throws MigrationException {
    ...
    public void migrateUnitData() throws MigrationException {
        ...
        try {
            ...
            unitCursor = getSqliteDatabase().rawQuery(sqlBuilder.toString(), null);
            if (null != unitCursor) {
    ...
    private void migrateLedgerGroups() throws MigrationException {
        ...
        try {
            ...
            sqlBuilder.append(" where IsGroup = 1");
            ledgerCursor = getSqliteDatabase().rawQuery(sqlBuilder.toString(), null);
    ...
    public void migrateLedgerData() throws MigrationException {
        ...
        try {
            ...
            if (null != ledgerCursor) {
                while (ledgerCursor.moveToNext()) {
                    ...
                    migrateLedgerBalances(account);

                    migrateLedgerPriceList(account);
    ...
    private void migrateLedgerBalances(Account account) throws MigrationException {
    ...
    private void migrateLedgerPriceList(Account account) throws MigrationException {
    ...
    public void migrateVoucherData() throws MigrationException {
        ...
        try {
            ...
            voucherCursor = getSqliteDatabase().rawQuery(sqlBuilder.toString(), null);
            if (null != voucherCursor) {
                while (voucherCursor.moveToNext()) {
                    ...
                    migrateVoucherEntries(voucher);
                    migrateVoucherItems(voucher);
                    migrateBhavEntry(voucher);
    ...
    private void migrateVoucherEntries(Voucher voucher) throws MigrationException {
    ...
    private void migrateVoucherItems(Voucher voucher) throws MigrationException {
    ...
    private void migrateBhavEntry(Voucher voucher) throws MigrationException {
        ...
        try {
            ...
            bhavEntryCursor = getSqliteDatabase().rawQuery(sql.toString(), null);
